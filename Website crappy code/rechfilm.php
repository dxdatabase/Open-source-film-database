           ...
           $nomfilm=explode(" ", $_GET['name']);
            ...
            if($f)
            {
                while($ligne=fgets($f))
                {
                    ...
                    } else { $afficheerreur="<p><font color='red'><b>Too much result, try to be more specific...</b></font></p>";}
                        } else {
...
} else { echo "Error... Try again : <a href='http://industrieplus.net/dxdatabase/'>http://industrieplus.net/dxdatabase</a><br><br>"; }
   fclose($f);
